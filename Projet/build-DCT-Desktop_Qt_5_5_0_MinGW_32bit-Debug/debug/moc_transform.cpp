...
QT_MOC_LITERAL(1, 10, 17), // "progressionSignal"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 8) // "pourcent"

    },
    "Transform\0progressionSignal\0\0pourcent"
};
...
void Transform::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->progressionSignal((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (Transform::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Transform::progressionSignal)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void Transform::progressionSignal(int _t1)
{
